...
// ...
getInstruction('mashedPotatoes', 0, (call0) => {
  document.querySelector("#mashedPotatoes").innerHTML += `<li>${call0}</li>`;
  getInstruction('mashedPotatoes', 1, (call1) => {
    document.querySelector("#mashedPotatoes").innerHTML += `<li>${call1}</li>`;
